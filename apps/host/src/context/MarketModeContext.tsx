...
const globalMarketModeContextKey = Symbol.for('MarketModeContext');
if (!(globalThis as any)[globalMarketModeContextKey]) {
  (globalThis as any)[globalMarketModeContextKey] = createContext<MarketModeContextType | undefined>(undefined);
}
const MarketModeContext = (globalThis as any)[globalMarketModeContextKey] as React.Context<MarketModeContextType | undefined>;
