...
const globalNotificationContextKey = Symbol.for('NotificationContext');
if (!(globalThis as any)[globalNotificationContextKey]) {
  (globalThis as any)[globalNotificationContextKey] = createContext<NotificationContextType | undefined>(undefined);
}
const NotificationContext = (globalThis as any)[globalNotificationContextKey] as React.Context<NotificationContextType | undefined>;
