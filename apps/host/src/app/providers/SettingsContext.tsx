...
const globalSettingsContextKey = Symbol.for('SettingsContext');
if (!(globalThis as any)[globalSettingsContextKey]) {
  (globalThis as any)[globalSettingsContextKey] = createContext<SettingsContextType | undefined>(undefined);
}
const SettingsContext = (globalThis as any)[globalSettingsContextKey] as React.Context<SettingsContextType | undefined>;
