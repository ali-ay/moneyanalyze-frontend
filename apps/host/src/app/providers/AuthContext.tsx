...
const globalAuthContextKey = Symbol.for('AuthContext');
if (!(globalThis as any)[globalAuthContextKey]) {
  (globalThis as any)[globalAuthContextKey] = createContext<AuthContextType | undefined>(undefined);
}
const AuthContext = (globalThis as any)[globalAuthContextKey] as React.Context<AuthContextType | undefined>;
