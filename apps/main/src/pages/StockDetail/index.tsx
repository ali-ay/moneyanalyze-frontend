...
import { ArrowLeft, TrendingUp, TrendingDown, Zap, AlertCircle, Calendar, Clock } from 'lucide-react';
...
const StockDetail: React.FC = () => {
  ...
  return (
    <PageContainer>
      <S.BackButton style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
        <Button
          $variant="secondary"
          $size="sm"
          onClick={() => navigate(-1)}
        ...
        >
          <Clock size={16} /> Hisse Hareket Geçmişi
        </Button>
      </S.BackButton>
